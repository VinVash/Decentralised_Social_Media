    ...
    <div className="flex gap-4 items-center p-4 w-full">
      ...
      <div className="w-full">
        <div className="flex justify-between item-center">
          ...
          <div>
            <span className="text-sm leading-5 text-gray-400 group-hover:text-gray-300 transition ease-in-out duration-150">
              {new Date(post[3] * 1000).toString().slice(4, 15)},{" "}
              {new Date(post[3] * 1000).toString().slice(17, 21)} IST
            </span>
          </div>
        </div>
        <div className="my-4">
